...
export const deleteAlternatifKriteriaByIdKriteria = async (id) => {
    return await api.delete(`/api/alternatifkriteria/${id}`)
}

export const deleteAlternatifKriteriaByAlternatifIdAndKriteriaId = async (idalt, idkrit) => {
    return await api.delete(`/api/alternatifkriteria/${idalt}/${idkrit}`)
}